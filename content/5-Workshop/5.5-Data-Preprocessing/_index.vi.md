...
* [**5.5.1:** Khởi tạo kho lưu trữ trung tâm S3 Data Lake.](5.3.1-S3-Data-Lake/)
* [**5.5.2:** Thiết lập luồng Kinesis Data Firehose để gom lô dữ liệu.](5.3.2-Firehose/)
* [**5.5.3:** Viết kịch bản kiểm định chất lượng dữ liệu thô (Raw Data).](5.3.3-Data-Validation/)
* [**5.5.4:** Tiền xử lý, chuẩn hóa tần suất (1H) và xuất định dạng Parquet.](5.3.4-Data-Processing/)
